...
C.dataset_path = osp.join(C.root_dir, 'dataset', 'NYUv2')
C.rgb_root_folder = osp.join(C.dataset_path, 'images')
C.rgb_format = '.jpg'
C.gt_root_folder = osp.join(C.dataset_path, 'labels40')
C.gt_format = '.png'
C.gt_transform = True
...
C.backbone = 'rgbd_tf0' # Remember change the path below.
